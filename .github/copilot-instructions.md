...
## Architecture
- This is a Debian package-oriented project: package metadata is in `control`, install mappings in `openmediavault.install`, and lifecycle/post-install logic in `openmediavault.postinst`.
